...
function StartState:init()
    ...
    -- color we'll use to change the title text
    self.colors = {
...
--[[
    Helper function for drawing just text backgrounds; draws several layers of
    the same text, in black, over top of one another for a thicker shadow.
]]
