...
--[[
    Keeps track of how much time has passed and decreases count if the times has exceeded our countdown time. If we have gone down to 0, we should transition to our PlayState.
]]
