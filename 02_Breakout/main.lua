...
--[[
    Called just once at the beginning of the gamel used to set up game objects, variables, etc. and prepare the game world.
]]
function love.load()
    ...
    gFrames = {
        ...
        ['powerup'] = GenerateQuadPowerup(gTextures['main']),
        ['lockedBricks'] = GenerateQuadsLockedBricks(gTextures['main']),
        ['key'] = GenerateQuadKey(gTextures['main'])
    }
...
--[[
    Called each frame after updatel is responsible simply for
...
--[[
    Loads high scores from a .lst file, saved in LOVE2D's default save directory in a subfolder called 'breakout'.
]]
